...
const int NewFightReq::kIsOfflineModeFieldNumber;
#endif  // !_MSC_VER
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 4: {
        ...
        if (input->ExpectTag(40)) goto parse_isOfflineMode;
        break;
      }
...
void NewFightReq::SerializeWithCachedSizes(
  ...
  if (has_isofflinemode()) {
    ::google::protobuf::internal::WireFormatLite::WriteBool(5, this->isofflinemode(), output);
  }
