...
class NewFightReq : public ::google::protobuf::MessageLite {
 public:
  ...
  // required bool isOfflineMode = 5;
  inline bool has_isofflinemode() const;
  inline void clear_isofflinemode();
  static const int kIsOfflineModeFieldNumber = 5;
...
// required bool isOfflineMode = 5;
inline bool NewFightReq::has_isofflinemode() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void NewFightReq::set_has_isofflinemode() {
  _has_bits_[0] |= 0x00000010u;
}
inline void NewFightReq::clear_has_isofflinemode() {
  _has_bits_[0] &= ~0x00000010u;
}
