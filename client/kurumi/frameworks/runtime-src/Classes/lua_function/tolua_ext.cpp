...
void tolua_ext_fvec2_value_to_luaval(lua_State* L, const NS_G::GFixedVec2& v, const char*)
{
	...
	lua_newtable(L);									/* L: table */
	lua_pushstring(L, "x");								/* L: table key */
	lua_pushnumber(L, (lua_Number)v.x.to_float());					/* L: table key value*/
	lua_rawset(L, -3);									/* table[key] = value, L: table */
	lua_pushstring(L, "y");								/* L: table key */
	lua_pushnumber(L, (lua_Number)v.y.to_float());					/* L: table key value*/
	lua_rawset(L, -3);									/* table[key] = value, L: table */
}
...
void tolua_ext_fvec3_value_to_luaval(lua_State* L, const NS_G::GFixedVec3& v, const char*)
{
	...
	lua_rawset(L, -3);									 /* table[key] = value, L: table */
	lua_pushstring(L, "z");								 /* L: table key */
	lua_pushnumber(L, (lua_Number)v.z.to_float());					 /* L: table key value*/
	lua_rawset(L, -3);									 /* table[key] = value, L: table */
}
