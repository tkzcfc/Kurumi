...
CCNetClient::CCNetClient(bool useKcp)
{
	//////////////////////////////////////////////////////////////////////////
	if (useKcp)
		m_client = std::unique_ptr<net_uv::KCPClient>(new net_uv::KCPClient());
	else
		m_client = std::unique_ptr<net_uv::TCPClient>(new net_uv::TCPClient());
	...
	//////////////////////////////////////////////////////////////////////////
	///
	m_msgMgr = std::unique_ptr<net_uv::NetMsgMgr>(new net_uv::NetMsgMgr());
	...
	Director::getInstance()->getScheduler()->schedule(static_cast<cocos2d::SEL_SCHEDULE>(&CCNetClient::update), this, 0.0f, false);
}
