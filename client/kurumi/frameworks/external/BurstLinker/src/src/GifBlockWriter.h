...
namespace blk {
    ...
    public:
        ...
        static void writeHeaderBlock(std::stringstream& file);

        static void writeLogicalScreenDescriptorBlock(std::stringstream& file, int32_t logicalScreenWidth,
        ...
        static void writeNetscapeLoopingExtensionBlock(std::stringstream& file, uint32_t loopCount);
        ...
        static void writeImageDataBlock(std::stringstream& file, uint8_t colorDepth, std::list<uint8_t *> lzw, int lzwSize);

        static void writeTerminator(std::stringstream& file);
