...
Panel_Content:setPosition(568.0000, 320.0000)
...
layout:setPercentHeight(1.0000)
layout:setSize({width = 1136.0000, height = 640.0000})
Panel_Content:addChild(PageView)
...
if callBackProvider~=nil then
      Button_Map1:addClickEventListener(callBackProvider("UI_MapWindow.lua", Button_Map1, "onClickSelectMap"))
end
...
Node_Yun:setPosition(1136.0000, 0.0000)
...
Panel_Content:addChild(Node_Yun)
...
ArmatureNode_Yun:setPosition(-95.9999, 527.2726)
...
ArmatureNode_Yun:getAnimation():play("fbyc01",-1, 1)
Node_Yun:addChild(ArmatureNode_Yun)

--Create ArmatureNode_Yun_0
local ArmatureNode_Yun_0 = ccs.Armature:create()
ArmatureNode_Yun_0:setName("ArmatureNode_Yun_0")
ArmatureNode_Yun_0:setTag(80)
ArmatureNode_Yun_0:setCascadeColorEnabled(true)
ArmatureNode_Yun_0:setCascadeOpacityEnabled(true)
ArmatureNode_Yun_0:setPosition(-88.1792, 134.8570)
layout = ccui.LayoutComponent:bindLayoutComponent(ArmatureNode_Yun_0)
layout:setLeftMargin(-88.1792)
layout:setRightMargin(88.1792)
layout:setTopMargin(-134.8570)
layout:setBottomMargin(134.8570)
ccs.ArmatureDataManager:getInstance():addArmatureFileInfo("plist/uianimation/fbylz.ExportJson")
ArmatureNode_Yun_0:init("fbylz")
ArmatureNode_Yun_0:getAnimation():play("fbyc02",-1, 1)
Node_Yun:addChild(ArmatureNode_Yun_0)

--Create ArmatureNode_Yun_1
local ArmatureNode_Yun_1 = ccs.Armature:create()
ArmatureNode_Yun_1:setName("ArmatureNode_Yun_1")
ArmatureNode_Yun_1:setTag(81)
ArmatureNode_Yun_1:setCascadeColorEnabled(true)
ArmatureNode_Yun_1:setCascadeOpacityEnabled(true)
ArmatureNode_Yun_1:setPosition(-121.4190, 281.5761)
layout = ccui.LayoutComponent:bindLayoutComponent(ArmatureNode_Yun_1)
layout:setLeftMargin(-121.4190)
layout:setRightMargin(121.4190)
layout:setTopMargin(-281.5761)
layout:setBottomMargin(281.5761)
ccs.ArmatureDataManager:getInstance():addArmatureFileInfo("plist/uianimation/fbylz.ExportJson")
ArmatureNode_Yun_1:init("fbylz")
ArmatureNode_Yun_1:getAnimation():play("fbya02",-1, 1)
Node_Yun:addChild(ArmatureNode_Yun_1)

--Create ArmatureNode_Yun_2
local ArmatureNode_Yun_2 = ccs.Armature:create()
ArmatureNode_Yun_2:setName("ArmatureNode_Yun_2")
ArmatureNode_Yun_2:setTag(82)
ArmatureNode_Yun_2:setCascadeColorEnabled(true)
ArmatureNode_Yun_2:setCascadeOpacityEnabled(true)
ArmatureNode_Yun_2:setPosition(-94.0950, 183.9130)
layout = ccui.LayoutComponent:bindLayoutComponent(ArmatureNode_Yun_2)
layout:setLeftMargin(-94.0950)
layout:setRightMargin(94.0950)
layout:setTopMargin(-183.9130)
layout:setBottomMargin(183.9130)
ccs.ArmatureDataManager:getInstance():addArmatureFileInfo("plist/uianimation/fbylz.ExportJson")
ArmatureNode_Yun_2:init("fbylz")
ArmatureNode_Yun_2:getAnimation():play("fbyb02",-1, 1)
Node_Yun:addChild(ArmatureNode_Yun_2)

--Create ArmatureNode_Yun_3
local ArmatureNode_Yun_3 = ccs.Armature:create()
ArmatureNode_Yun_3:setName("ArmatureNode_Yun_3")
ArmatureNode_Yun_3:setTag(83)
ArmatureNode_Yun_3:setCascadeColorEnabled(true)
ArmatureNode_Yun_3:setCascadeOpacityEnabled(true)
ArmatureNode_Yun_3:setPosition(-48.5907, 440.1068)
layout = ccui.LayoutComponent:bindLayoutComponent(ArmatureNode_Yun_3)
layout:setLeftMargin(-48.5907)
layout:setRightMargin(48.5907)
layout:setTopMargin(-440.1068)
layout:setBottomMargin(440.1068)
ccs.ArmatureDataManager:getInstance():addArmatureFileInfo("plist/uianimation/fbylz.ExportJson")
ArmatureNode_Yun_3:init("fbylz")
ArmatureNode_Yun_3:getAnimation():play("fbya03",-1, 1)
Node_Yun:addChild(ArmatureNode_Yun_3)

--Create ArmatureNode_Yun_4
local ArmatureNode_Yun_4 = ccs.Armature:create()
ArmatureNode_Yun_4:setName("ArmatureNode_Yun_4")
ArmatureNode_Yun_4:setTag(84)
ArmatureNode_Yun_4:setCascadeColorEnabled(true)
ArmatureNode_Yun_4:setCascadeOpacityEnabled(true)
ArmatureNode_Yun_4:setPosition(-32.5121, 67.6394)
layout = ccui.LayoutComponent:bindLayoutComponent(ArmatureNode_Yun_4)
layout:setLeftMargin(-32.5121)
layout:setRightMargin(32.5121)
layout:setTopMargin(-67.6394)
layout:setBottomMargin(67.6394)
ccs.ArmatureDataManager:getInstance():addArmatureFileInfo("plist/uianimation/fbylz.ExportJson")
ArmatureNode_Yun_4:init("fbylz")
ArmatureNode_Yun_4:getAnimation():play("fbya01",-1, 1)
Node_Yun:addChild(ArmatureNode_Yun_4)
...
if callBackProvider~=nil then
      Button_Left:addClickEventListener(callBackProvider("UI_MapWindow.lua", Button_Left, "onClickLeft"))
end
...
Panel_Content:addChild(Button_Left)
...
if callBackProvider~=nil then
      Button_Right:addClickEventListener(callBackProvider("UI_MapWindow.lua", Button_Right, "onClickRight"))
end
...
layout:setTopMargin(270.0000)
layout:setBottomMargin(270.0000)
Panel_Content:addChild(Button_Right)
...
if callBackProvider~=nil then
      Button_2:addClickEventListener(callBackProvider("UI_MapWindow.lua", Button_2, "onClickBack"))
end
