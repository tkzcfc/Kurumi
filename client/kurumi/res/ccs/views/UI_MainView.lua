...
--Create FileNode_3
innerCSD = require("ccs.ui.home.Yun")
...
--Create FileNode_2
innerCSD = require("ccs.ui.home.taohua1")
innerProject = innerCSD.create(callBackProvider)
...
ccs.ArmatureDataManager:getInstance():addArmatureFileInfo("plist/zhuc_ldpi/huos.ExportJson")
...
ccs.ArmatureDataManager:getInstance():addArmatureFileInfo("plist/zhuc_ldpi/lhjz.ExportJson")
...
ccs.ArmatureDataManager:getInstance():addArmatureFileInfo("plist/zhuc_ldpi/zhucheng_niaojuchangjing.ExportJson")
...
--Create FileNode_1
innerCSD = require("ccs.ui.home.taohua2")
innerProject = innerCSD.create(callBackProvider)
...
ccs.ArmatureDataManager:getInstance():addArmatureFileInfo("plist/npc/zhucheng_nvzhu.ExportJson")
ArmatureNode_1:init("zhucheng_nvzhu")
ArmatureNode_1:getAnimation():play("stand1",-1, 1)
ScrollView:addChild(ArmatureNode_1)

--Create npcnamebg_2
local npcnamebg_2 = cc.Sprite:create("plist/ui/fragment/npcnamebg.png")
...
ccs.ArmatureDataManager:getInstance():addArmatureFileInfo("plist/zhuc_ldpi/sg2.ExportJson")
...
ccs.ArmatureDataManager:getInstance():addArmatureFileInfo("plist/zhuc_ldpi/youxjz.ExportJson")
...
ccs.ArmatureDataManager:getInstance():addArmatureFileInfo("plist/zhuc_ldpi/zhucheng_fengyinshi.ExportJson")
...
ccs.ArmatureDataManager:getInstance():addArmatureFileInfo("plist/zhuc_ldpi/zhucheng_jingjichang.ExportJson")
...
ccs.ArmatureDataManager:getInstance():addArmatureFileInfo("plist/zhuc_ldpi/zhucheng_paihangbang.ExportJson")
...
ccs.ArmatureDataManager:getInstance():addArmatureFileInfo("plist/zhuc_ldpi/sdjz.ExportJson")
...
ccs.ArmatureDataManager:getInstance():addArmatureFileInfo("plist/zhuc_ldpi/zhucheng_yaodaofang.ExportJson")
...
ccs.ArmatureDataManager:getInstance():addArmatureFileInfo("plist/zhuc_ldpi/ccjz.ExportJson")
...
ccs.ArmatureDataManager:getInstance():addArmatureFileInfo("plist/npc/zhucheng_nvzhu2.ExportJson")
ArmatureNode_2:init("zhucheng_nvzhu2")
ArmatureNode_2:getAnimation():play("stand1",-1, 1)
ScrollView:addChild(ArmatureNode_2)

--Create npcnamebg_1
local npcnamebg_1 = cc.Sprite:create("plist/ui/fragment/npcnamebg.png")
...
layout:setPercentWidth(1.0000)
layout:setPercentHeight(1.0000)
layout:setSize({width = 2880.0000, height = 640.0000})
ScrollView:addChild(Panel_Touch)
...
Button_1:setCapInsets({x = -15, y = -4, width = 30, height = 8})
...
Button_1:setPosition(1179.6280, 427.8951)
Button_1:setScaleX(3.1785)
Button_1:setScaleY(14.6149)
Button_1.UserData = {}
Button_1.UserData[1] = [==========[1]==========]
layout = ccui.LayoutComponent:bindLayoutComponent(Button_1)
layout:setPositionPercentX(0.4096)
layout:setPositionPercentY(0.6686)
layout:setPercentWidth(0.0146)
layout:setPercentHeight(0.0219)
layout:setSize({width = 42.0000, height = 14.0000})
layout:setLeftMargin(1158.6280)
layout:setRightMargin(1679.3720)
layout:setTopMargin(205.1049)
layout:setBottomMargin(420.8951)
Panel_Touch:addChild(Button_1)
...
Button_2:setCapInsets({x = -15, y = -4, width = 30, height = 8})
...
Button_2:setPosition(2225.6900, 334.5906)
Button_2:setScaleX(6.5354)
Button_2:setScaleY(14.6149)
Button_2.UserData = {}
Button_2.UserData[1] = [==========[2]==========]
...
layout:setPercentHeight(0.0219)
layout:setSize({width = 42.0000, height = 14.0000})
layout:setLeftMargin(2204.6900)
layout:setRightMargin(633.3101)
layout:setTopMargin(298.4094)
layout:setBottomMargin(327.5906)
Panel_Touch:addChild(Button_2)
...
Button_2_0:setCapInsets({x = -15, y = -4, width = 30, height = 8})
Button_2_0:setLayoutComponentEnabled(true)
Button_2_0:setName("Button_2_0")
Button_2_0:setTag(74)
Button_2_0:setCascadeColorEnabled(true)
Button_2_0:setCascadeOpacityEnabled(true)
Button_2_0:setPosition(1427.9390, 250.3032)
Button_2_0:setScaleX(4.7385)
Button_2_0:setScaleY(14.6149)
Button_2_0.UserData = {}
Button_2_0.UserData[1] = [==========[3]==========]
layout = ccui.LayoutComponent:bindLayoutComponent(Button_2_0)
layout:setPositionPercentX(0.4958)
layout:setPositionPercentY(0.3911)
layout:setPercentWidth(0.0146)
layout:setPercentHeight(0.0219)
layout:setSize({width = 42.0000, height = 14.0000})
layout:setLeftMargin(1406.9390)
layout:setRightMargin(1431.0610)
layout:setTopMargin(382.6968)
layout:setBottomMargin(243.3032)
Panel_Touch:addChild(Button_2_0)
