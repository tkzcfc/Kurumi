...
local MapWindow = class("MapWindow", G_Class.UIMainFrame)

function MapWindow:ctor()
	MapWindow.super.ctor(self)

	self:loadUILua("ccs.ui.home.UI_MapWindow")
...
function MapWindow:onExit()
    ...
    _MyG.SysSetManager:getStorage().iSelectPageIndex = self.iCurPage
end
...
function MapWindow:initPageView()
    ...
    self.iCurPage = _MyG.SysSetManager:getStorage().iSelectPageIndex or 0
