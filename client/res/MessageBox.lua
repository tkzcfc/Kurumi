...
Image_BG:setPosition(583.4121, 317.2063)
...
layout:setLeftMargin(299.5499)
layout:setRightMargin(268.7257)
layout:setTopMargin(142.6520)
layout:setBottomMargin(137.0646)
...
Button_OK:setPosition(147.3371, 63.6973)
...
layout:setLeftMargin(77.3371)
layout:setRightMargin(350.3873)
layout:setTopMargin(266.5861)
layout:setBottomMargin(33.6973)
...
Button_Cancel:setPosition(397.7294, 65.0403)
if callBackProvider~=nil then
...
layout:setPercentHeight(0.1665)
layout:setSize({width = 140.0000, height = 60.0000})
layout:setLeftMargin(333.3854)
layout:setRightMargin(94.3390)
layout:setTopMargin(265.2430)
layout:setBottomMargin(35.0403)
...
Image_4:setPosition(283.8616, 183.7873)
...
layout:setLeftMargin(46.8962)
layout:setRightMargin(46.8974)
...
Text_show:setPosition(236.9654, 81.3374)
