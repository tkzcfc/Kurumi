...
Image:loadTexture("cont/ay02.png",0)
...
Button_Skill:loadTextureNormal("cont/c_but_1.png",0)
Button_Skill:loadTexturePressed("cont/c_but_2.png",0)
...
if callBackProvider~=nil then
      Button_Skill:addClickEventListener(callBackProvider("playerControlUI.lua", Button_Skill, "onClickSkill"))
end
...
local Image = ccui.ImageView:create()
Image:ignoreContentAdaptWithSize(false)
Image:loadTexture("cont/xiazhan.png",0)
Image:setLayoutComponentEnabled(true)
Image:setName("Image")
Image:setTag(24)
Image:setCascadeColorEnabled(true)
...
local Image = ccui.ImageView:create()
Image:ignoreContentAdaptWithSize(false)
Image:loadTexture("cont/xulizhan.png",0)
Image:setLayoutComponentEnabled(true)
Image:setName("Image")
Image:setTag(27)
Image:setCascadeColorEnabled(true)
...
local Image = ccui.ImageView:create()
Image:ignoreContentAdaptWithSize(false)
Image:loadTexture("cont/ay01.png",0)
Image:setLayoutComponentEnabled(true)
Image:setName("Image")
Image:setTag(30)
Image:setCascadeColorEnabled(true)
