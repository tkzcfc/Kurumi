...
if callBackProvider~=nil then
      Button_OK:addClickEventListener(callBackProvider("ScrollMessageBox.lua", Button_OK, "onClickOK"))
end
...
if callBackProvider~=nil then
      Button_Cancel:addClickEventListener(callBackProvider("ScrollMessageBox.lua", Button_Cancel, "onClickCancel"))
end
...
layout:setLeftMargin(11.9656)
layout:setRightMargin(11.9656)
