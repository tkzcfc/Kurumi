local ScrollMsgBoxUI = class("ScrollMsgBoxUI", cc.Node)


function ScrollMsgBoxUI:ctor()
	self.ui = _MyG.loadStudioFile("ScrollMessageBox", self)
...
function ScrollMsgBoxUI:showBox(content, okcall, cancelcall)
	self:hideBox()
	self.okcall = okcall
...
function ScrollMsgBoxUI:hideBox()
	self:removeFromParent()
end

function ScrollMsgBoxUI:setTitle(title)
	self.ui.Text_Title:setString(title)
end

function ScrollMsgBoxUI:setButtonOKTitle(title)
	self.ui.Button_OK:setTitleText(title)
end

function ScrollMsgBoxUI:setButtonCancelTitle(title)
	self.ui.Button_Cancel:setTitleText(title)
end

function ScrollMsgBoxUI:onClickOK(sender)
	if self.okcall then
		self.okcall()
	end
	self:hideBox()
...
function ScrollMsgBoxUI:onClickCancel(sender)
