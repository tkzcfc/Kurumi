///*
//** Lua binding: ecs
//** Generated automatically by tolua++-1.0.92 on 11/08/20 14:14:51.
//*/
//
//#ifndef __cplusplus
//#include "stdlib.h"
...
//  tolua_Error tolua_err;
//  if (!self) tolua_error(tolua_S,"invalid 'self' in accessing variable 'm_attCollisionCall'",NULL);
//  if ((tolua_isvaluenil(tolua_S,2,&tolua_err) || !toluafix_isfunction(tolua_S,2,"LUA_FUNCTION",0,&tolua_err)))
//   tolua_error(tolua_S,"#vinvalid type in variable assignment.",&tolua_err);
//#endif
//  self->m_attCollisionCall = (  toluafix_ref_function(tolua_S,2,0))
//;
// return 0;
//}
//#endif //#ifndef TOLUA_DISABLE
...
//   tolua_error(tolua_S,"#vinvalid type in variable assignment.",&tolua_err);
//#endif
//  self->m_defCollisionCall = (  toluafix_ref_function(tolua_S,2,0))
//;
// return 0;
//}
//#endif //#ifndef TOLUA_DISABLE
...
//   tolua_error(tolua_S,"#vinvalid type in variable assignment.",&tolua_err);
//#endif
//  self->m_syncPhysicsTransformCall = (  toluafix_ref_function(tolua_S,2,0))
//;
// return 0;
//}
//#endif //#ifndef TOLUA_DISABLE
...
//   tolua_error(tolua_S,"#vinvalid type in variable assignment.",&tolua_err);
//#endif
//  self->m_orientationTurnCall = (  toluafix_ref_function(tolua_S,2,0))
//;
// return 0;
//}
//#endif //#ifndef TOLUA_DISABLE
...
//   tolua_error(tolua_S,"#vinvalid type in variable assignment.",&tolua_err);
//#endif
//  self->m_updateCall = (  toluafix_ref_function(tolua_S,2,0))
//;
// return 0;
//}
//#endif //#ifndef TOLUA_DISABLE
...
//   tolua_error(tolua_S,"#vinvalid type in variable assignment.",&tolua_err);
//#endif
//  self->m_lastUpdateCall = (  toluafix_ref_function(tolua_S,2,0))
//;
// return 0;
//}
//#endif //#ifndef TOLUA_DISABLE
